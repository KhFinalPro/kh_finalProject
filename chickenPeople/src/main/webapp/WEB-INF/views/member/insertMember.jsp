            ...
            <ul>
                <ul>
                    <li style="list-style: none;">
                        ...
                        <label>(필수)이용약관</label>
                        <label><a href="agreement.do">전체보기</a></label>
                    </li>
                    <br>
                    <ul>
                        <li style="list-style: none;">
                            <div class="container">
                                <pre>
제1조 (목적)
본 약관은 유한책임회사 딜리버리히어로코리아(이하 “회사”라 함)가 운영하는 치킨의민족 사이트(www.치킨의민족.co.kr) 또는 “치킨의 민족” 모바일 애플리케이션에서 제공하는 서비스(이하 “서비스”라 함)를 이용함에 있어 “치킨의 민족”와 이용자의 권리, 의무 및 책임 사항을 규정함을 목적으로 합니다.
제2조 (정의)
① “치킨의민족”란 회사가 “서비스”를 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역(이하 “재화 등”이라 함)을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 “치킨의 민족”를 운영하는 사업자의 의미로도 사용합니다.
② “치킨의민족서비스”란 회사가 운영하는 사이트나 모바일 애플리케이션을 통해 이용자가 원하는 재화 등을 주문하면, 주문이 완료된 재화 등을 가맹점이 이용자에게 배달하는 서비스를 기본으로 하되, 배달대행, 테이크아웃 등 “치킨의 민족” 사이트 및 모바일 애플리케이션 상의 제공 서비스 전체를 의미합니다.
③ “이용자”란 “치킨의민족”에 접속하여 본 약관에 따라 치킨의민족 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
④ “회원”이라 함은 “치킨의민족”에 개인정보를 제공하여 회원등록을 한 자로서, “치킨의민족”의 정보를 지속적으로 제공받으며, “치킨의 민족”가 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.
...
제3조 (약관의 명시와 설명 및 개정)
① “치킨의 민족”는 본 약관의 내용과 상호, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 대표자의 성명, 사업자등록번호, 연락처(전화, 팩스, 전자우편 주소 등), 통신판매업신고번호, 개인정보관리책임자 등을 이용자가 알 수 있도록 “치킨의 민족” 쇼핑몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
② “치킨의 민족”는 이용자가 약관에 동의하기에 앞서 약관에 정하여져 있는 내용 중 청약철회 ∙ 배송책임 ∙ 환불조건 등과 같은 중요한 내용을 이용자가 이해할 수 있도록 별도의 연결화면 또는 팝업화면 등을 제공하여 이용자의 확인을 구하여야 합니다.
③ “치킨의 민족”는 「전자상거래 등에서의 소비자 보호에 관한 법률」, 「약관의 규제에 관한 법률」, 「전자거래기본법」, 「전자서명법」, 「정보통신망이용촉진 및 정보보호 등에 관한 법률」, 「방문판매 등에 관한 법률」, 「소비자보호법」 등 관련법을 위배하지 않는 범위에서 본 약관을 개정할 수 있습니다.
④ “치킨의 민족”가 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 “치킨의 민족”의 초기화면에 그 적용일자 7일 이전부터 적용일자 전일까지 공지합니다. 다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우 “치킨의 민족”는 개정 전 내용과 개정 후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.
⑤ “치킨의 민족”가 약관을 개정할 경우에는 개정약관의 효력발생일 이후 회원이 서비스를 이용하는 경우, “치킨의 민족”는 회원이 개정약관에 동의한 것으로 봅니다.
⑥ 개정 약관조항은 개정 약관의 적용일자 이후에 체결된 계약에 한하여 적용되는 것을 원칙으로 합니다. 다만, “치킨의 민족”가 지정하는 방식에 따라 회원이 동의를 한 경우에는 개정약관 조항이 적용됩니다.
⑦ 변경된 약관에 대한 정보를 알지 못해 발생하는 이용자의 피해는 “치킨의 민족”에서 책임지지 않습니다. 단, 회원이 개정 약관에 동의하지 아니할 때에는 회원은 “치킨의 민족”에 대하여 회원의 탈퇴 기타 이용계약을 해지할 수 있습니다.
...
① “치킨의 민족”는 다음과 같은 업무를 수행합니다.
1. 재화 등과 관련한 전자상거래 중개 및 배달대행
2. 재화 등 또는 관련 용역에 대한 정보 제공 및 구매계약의 체결
3. 기타 “치킨의 민족”가 정하는 업무
② “치킨의 민족”는 재화 등의 품절 또는 기술적 사양의 변경 등의 사유가 발생하는 경우 장차 체결되는 계약에 의해 제공할 치킨의 민족서비스의 내용을 변경할 수 있으며, 오로지 가맹점의 사정(가맹점의 고의나 과실로 “치킨의 민족” 사이트에 재화 등의 메뉴 업데이트가 이루어지지 않는 것을 포함하나 이에 한하지 아니함)으로 인해 해당 관련 서비스의 중단이 불가피한 사정이 있는 경우에는 이미 체결된 계약의 해당 주문 건에 대한 서비스를 개별적으로 중단할 수 있습니다. 위 각 경우에는 변경된 재화 등의 내용 및 제공일자를 명시하여 현재의 재화 등의 내용을 게시한 곳에 즉시 공지합니다.
③ “치킨의 민족”가 이용자와 계약을 체결한 서비스의 내용을 전항의 사유로 변경하거나 중단할 경우에는 그 사유를 이용자에게 통지 가능한 연락처(주소, 전자우편, 전화 등)로 즉시 통지합니다.
④ 전항의 경우 “치킨의 민족”는 이로 인하여 이용자가 입은 손해를 배상합니다. 단, “치킨의 민족”가 고의 또는 과실이 없음을 입증하는 경우에는 그러하지 아니합니다.
제5조 (서비스의 중지)
① “치킨의 민족”는 다음 각 호 중 어느 하나에 해당하는 사유가 발생하는 경우에는 이용자의 서비스 이용을 제한하거나 중지할 수 있습니다.
...
② 제1항에 의한 서비스 중지의 경우에는 “치킨의 민족”는 제9조에 정한 방법으로 이용자에게 통지합니다.
③ “치킨의 민족”는 제1항의 사유로 서비스의 제공이 일시적으로 중지됨으로 인하여 이용자 또는 제3자가 입은 손해에 대하여 배상합니다. 단, “치킨의 민족”에 고의 또는 과실이 없는 경우에는 그러하지 아니합니다.
제6조 (회원가입)
① 이용자는 “치킨의 민족”가 정한 가입 양식에 따라 회원정보를 기입한 후 본 약관에 동의한다는 의사표시를 함으로서 회원가입을 신청합니다.
② “치킨의 민족”는 제1항과 같은 회원가입 신청에 대하여 승낙함으로써 회원가입계약이 성립하며, 다음 각 호 중 어느 하나에 해당하는 이용자의 회원가입 신청에 대해서는 이를 거부할 수 있습니다.
1. 가입신청자가 본 약관 제9조 제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 다만 제9조 제3항에 의한 회원자격 상실 후 3년이 경과한 자로서 “치킨의 민족”의 회원 재가입 승낙을 얻은 경우에는 예외로 합니다.
2. 등록 내용에 허위, 기재누락, 오기가 있는 경우
3. 기타 회원으로 등록하는 것이 “치킨의 민족”의 기술상 현저히 지장이 있다고 판단되는 경우
③ 회원가입계약의 성립시기는 “치킨의 민족”의 승낙이 회원에게 도달한 시점으로 합니다.
④ 회원은 제18조 제1항에 의한 등록사항에 변경이 있는 경우, 즉시 전자우편 기타 방법으로 “치킨의 민족”에 대하여 그 변경사항을 알려야 합니다.
⑤ 개인정보 보호를 위하여 만 14세 미만 아동의 회원 가입은 제한됩니다.
⑥ 외국인 또는 해외교민은 “회사”가 제공하는 가입조건을 만족할 경우, 가입이 가능합니다.
제7조 (회원의 권리)
① 회원으로 등록하시면 치킨의 민족서비스의 모든 메뉴를 제약 없이 사용하실 수 있습니다.
② “치킨의 민족”가 제공하는 다양한 생활정보 서비스와 각종 이벤트에 참가할 자격이 주어집니다.
③ 치킨의 민족서비스의 최신정보와 혜택 수신을 원하는 경우에는 전자우편/ 서신우편/ 문자메시지/ 앱푸쉬 등의 매체로 받아보실 수 있습니다.
제8조 (서비스 이용요금)
...
① “치킨의 민족”는 회원이 자신 계정의 마지막 로그인 일시로부터 1년이 초과되는 시점까지 다시 로그인을 하지 않은 경우, 해당 회원의 계정을 휴면계정으로 전환합니다. 또한 전환과 동시에 “치킨의 민족” 개인정보처리방침에 따라 해당 회원의 개인정보는 3년 간 보관되며, 해당 기간에 한하여 계정 복구도 가능합니다.
② 회원은 “치킨의 민족”에 언제든지 탈퇴를 요청할 수 있으며 “치킨의 민족”는 해당 요청을 받는 즉시 회원탈퇴를 처리합니다. 단, 회원 재가입, 임의해지 등을 반복적으로 행함으로써 “치킨의 민족”가 제공하는 각종 할인쿠폰, 이벤트 혜택 등의 경제상의 이익을 편법적으로 수취하는 것을 방지하기 위하여 “치킨의 민족”는 개인정보처리방침에 따라 해당 회원의 개인정보를 90일 간 보관합니다.
③ “치킨의 민족”는 회원이 다음 각 호에 해당되는 경우 별도의 통보절차 없이 회원의 자격을 정지할 수 있습니다.
1. 회원가입 신청이나, 회원정보의 변경 시 허위내용을 작성한 경우
2. 타인의 명의를 임의로 사용하는 경우
3. 타인에게 피해를 주거나 기타 미풍양속을 현저히 저해하는 행위를 한 경우
4. 치킨의 민족서비스에 제공되는 정보를 변경 및 수정하는 등 치킨의 민족서비스의 정상적인 운영을 고의 또는 중과실로 방해하는 행위를 한 경우
5. 치킨의 민족서비스를 이용하여 구입한 재화 등의 대금, 기타 메뉴 몰의 이용에 관련하여 회원이 부담하는 채무를 기일 내에 지급하지 않는 경우
6. “치킨의 민족”에 귀속하는 저작권 등 지적재산권을 침해한 경우
7. “치킨의 민족”의 명예를 대외적으로 훼손시켰다고 인정되는 경우
8. 기타 “치킨의 민족”가 정한 회원가입요건이 미비 되었거나 회원으로서의 자격을 지속시키는 것이 부적절하다고 판단되는 경우
9. 기타 본 약관에 위반한 행위를 한 경우
④ “치킨의 민족”가 회원자격을 상실시키는 경우에는 회원등록을 말소합니다. 본 경우 회원에게 이를 통지하고, 회원등록 말소 전에 최소한 30일 이상의 기간을 정하여 소명할 기회를 부여합니다.
제10조 (회원에 대한 통지)
① “치킨의 민족”가 회원에 대한 통지를 하는 경우, 회원이 “치킨의 민족”와 미리 약정하여 지정한 전자우편 주소로 할 수 있습니다.
② “치킨의 민족”는 불특정다수 회원에 대한 통지의 경우 1주일 이상 “치킨의 민족” 게시판에 게시함으로써 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.
제11조 (“치킨의 민족”와 “치킨의 민족” 연결 사이트 간의 관계)
① “치킨의 민족”는 “치킨의 민족” 연결 사이트가 취급하는 재화 등에 대하여 보증책임을 지지 않습니다.
② “치킨의 민족”와 “치킨의 민족” 연결 사이트는 독자적으로 가맹점을 운영하는 것으로 “치킨의 민족”는 “치킨의 민족” 연결 사이트와 이용자 간에 행해진 거래에 대하여 어떠한 책임도 지지 않습니다.
제12조 (구매신청)
“치킨의 민족” 이용자는 “치킨의 민족” 상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “치킨의 민족”는 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다. 단, 회원인 경우 제2호 내지 제4호의 적용을 제외할 수 있습니다.
1. 재화 등의 검색 및 선택
...
5. 재화 등의 구매신청 및 이에 관한 확인 또는 “치킨의 민족”의 확인에 대한 동의
6. 결제방법의 선택
제13조 (계약의 성립)
① “치킨의 민족”는 다음 각 호에 해당하는 경우 제12조의 구매신청을 승낙하지 않을 수 있습니다.
1. 신청 내용에 허위, 기재누락, 오기가 있는 경우
2. 미성년자가 담배, 주류 등 「청소년보호법」에서 금지하는 재화 등을 구매하는 경우
3. 기타 구매신청에 승낙하는 것이 “치킨의 민족” 기술상 현저히 지장이 있다고 판단하는 경우
② “치킨의 민족”의 승낙이 제15조 제1항의 수신확인통지형태로 이용자에게 도달한 시점에 계약이 성립한 것으로 봅니다.
③ “치킨의 민족”의 승낙의 의사표시에는 이용자의 구매 신청에 대한 확인 및 판매가능 여부, 구매신청의 정정 취소 등에 관한 정보 등을 포함하여야 합니다.
...
제14조 (이용자의 대금지급방법)
“치킨의 민족”에서 구매한 재화 등에 대한 대금지급방법은 다음 각 호의 방법 중 가용한 방법으로 할 수 있습니다. 단, “치킨의 민족”는 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도 추가하여 징수할 수 없습니다.
1. 폰뱅킹, 인터넷뱅킹, 메일 뱅킹 등의 각종 계좌이체
2. 선불카드, 직불카드, 신용카드 등의 각종 카드 결제
3. 온라인무통장입금
4. 전자화폐에 의한 결제
5. 수령 시 대금지급
6. 마일리지 등 “치킨의 민족”가 지급한 포인트에 의한 결제
7. “치킨의 민족”와 계약을 맺었거나 “치킨의 민족”가 인정한 상품권에 의한 결제
8. 기타 전자적 지급 방법에 의한 대금 지급 등
제15조 (주문성공의 통지 및 구매신청 변경 및 취소)
① 이 “치킨의 민족” 기술상 현저히 지장이 있다고 판단하는 경우”치킨의 민족”는 이용자의 구매신청이 있는 경우, 구매정보가 가맹점에 정확히 전달되면 이용자(또는 회원)와 가맹점에 주문 성공 메시지를 전송하여 통지를 합니다.
② 확인통지를 받은 이용자는 의사표시의 불일치 등이 있는 경우에는 확인통지를 받은 후 즉시, 직접 “치킨의 민족” 연락처로 구매신청 변경 및 취소를 요청할 수 있습니다. 단, 이용자의 귀책사유로 인한 구매신청의 변경 또는 취소는 가맹점의 사정에 따라 받아들여지지 아니할 수 있으며, 이로 인하여 이용자에게 발생하는 손해에 대하여 “치킨의 민족”는 고의 또는 과실이 없는 한 책임을 부담하지 않습니다.
③ 신용카드에 의한 결제에 따른 지급의 경우에 신용카드회사가 “치킨의 민족”에 대하여 신용카드의 연체, 무효 또는 기타 사유로 인한 지급 불능 등을 통지한 경우, “치킨의 민족”는 회원 등 이용자에게 지급방법의 변경 여부 등에 관한 확인을 할 수 있습니다. 회원 등 이용자가 제공한 주소, 전화번호 또는 전자우편 주소를 통하여 이러한 확인에 이르지 못하는 경우, “치킨의 민족”는 당해 회원 등 이용자와의 카드결제를 통한 매매계약을 취소할 수 있습니다.
제16조 (배달)
① “치킨의 민족”는 이용자의 주문내용 정보와 고객의 결제내역에 대한 정보를 가맹점에 정확히 전달함으로 책임을 다하며, 가맹점이 배달을 완료합니다.
...
③ “치킨의 민족”는 이용자가 구매한 재화 등이 시간을 초과하여 배달되거나 약속한 시간 내에 배달되지 않음으로 인한 이용자의 손해를 배상할 의무가 없으며 배달지연에 대한 책임은 가맹점에서 집니다.
④ 해당 가맹점의 고의 또는 과실로 약정 배달시간을 초과한 경우에는 그로 인한 이용자의 손해를 해당 가맹점에서 배상합니다.
⑤ 본 조의 내용에도 불구하고 “치킨의 민족”가 이용자에게 배달대행 서비스를 제공하는 경우에는 제35조가 우선하여 적용됩니다.
제17조 (환불, 반품 및 교환)
① “치킨의 민족”는 이용자가 구매 신청한 재화 등을 부득이 한 사정으로 제공을 할 수 없을 때에는 지체 없이 그 사유를 이용자에게 통지하고, 이미 대금을 받은 경우에는 대금을 받은 후 3일 이내에 환급절차를 취합니다.
...
④ 이용자가 주문이 최종적으로 완료되기 전에 인터넷 창을 닫는 등의 사용방법을 충분히 숙지하지 못하여 발생하는 주문의 실패에 대해서 “치킨의 민족”는 책임지지 않습니다.
제18조 (개인정보보호)
치킨의 민족”는 이용자의 개인정보 보호를 위하여 별도의 개인정보처리방침을 마련하였으므로, 구체적인 내용은 해당 개인정보처리방침을 확인하여 주시기 바랍니다.
제19조 (“치킨의 민족”의 의무)
① “치킨의 민족”는 법령과 본 약관이 금지하거나 공서양속(사회의 일반적 도덕 및 기타 사회의 공공적 질서)에 반하는 행위를 하지 않으며 본 약관이 정하는 바에 따라 지속적이고, 안정적으로 재화 등을 제공하는 데 최선을 다하여야 합니다.
② “치킨의 민족”는 이용자가 안전하게 인터넷 서비스를 이용할 수 있도록 이용자의 개인정보(신용정보 포함)보호를 위한 보안 시스템을 갖추어야 합니다.
③ “치킨의 민족”의 재화 등에 대해 “치킨의 민족”의 고의 또는 과실로 인하여 「표시·광고의 공정화에 관한 법률」 제3조 소정의 부당한 표시·광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을 집니다. 단, 가맹점의 부당한 표시 ∙ 광고행위로 인한 이용자의 손해에 대해서는 “치킨의 민족”가 책임을 부담하지 아니합니다.
제20조 (회원의 ID 및 비밀번호에 대한 의무)
① 제18조의 경우를 제외한 ID와 비밀번호에 관한 관리책임은 회원에게 있습니다.
② 회원은 자신의 ID 및 비밀번호를 제3자에게 이용하게 해서는 아니 되며, 회원이 이를 위반하여 발생하는 손해에 대해서는 “치킨의 민족”가 책임을 부담하지 아니합니다.
③ 회원이 자신의 ID 및 비밀번호를 도난 당하거나 제3자가 사용하고 있음을 인지한 경우에는 바로 “치킨의 민족”에 통보하고 “치킨의 민족”의 안내가 있는 경우에는 그에 따라야 합니다.
제21조 (이용자의 의무)
이용자는 다음 행위를 하여서는 안됩니다.
1. 신청 또는 변경 시 허위내용의 등록
2. 타인의 정보 도용
3. “치킨의 민족”에 게시된 정보의 변경
4. “치킨의 민족”가 정한 정보 이외의 정보(컴퓨터 프로그램 등)의 송신 또는 게시
5. “치킨의 민족” 및 기타 제3자의 저작권 등 지적재산권에 대한 침해
6. “치킨의 민족” 및 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위
7. 외설 또는 폭력적인 메시지·화상·음성 기타 공서양속(사회의 일반적 도덕 및 기타 사회의 공공적 질서)에 반하는 정보를 “치킨의 민족”에 공개 또는 게시하는 행위
8. 배달된 또는 수령한 재화 등에 대한 맛의 평가와 관련하여 의도적으로 악의적인 게시글을 올리는 행위
제22조 (“치킨의 민족”와 “치킨의 민족” 연결 사이트 간의 관계)
“치킨의 민족”는 “치킨의 민족” 연결 사이트가 독자적으로 제공하는 재화 등에 의하여 이용자와 행하는 거래에 대해서 보증책임을 지지 않는다는 뜻을 “치킨의 민족”의 초기화면 또는 연결되는 시점의 팝업화면으로 명시한 경우에는 그 거래에 대한 보증책임을 지지 않습니다.
제23조 (저작권의 귀속 및 이용제한)
① “치킨의 민족”가 작성한 저작물에 대한 저작권 기타 지적재산권은 “치킨의 민족”에 귀속합니다.
② 게시물에 대한 권리와 책임은 게시자에게 있으며, “치킨의 민족”는 게시물에 대한 사용권한을 갖습니다. 이 경우 회사는 저작권법의 내용을 준수하며, 게시자는 언제든지 고객센터 또는 서비스 내 관리기능을 통해 해당 게시물에 대해 삭제, 검색 결과 제외, 비공개 등의 조치를 취할 수 있습니다.
③ “치킨의 민족”는 치킨의 민족서비스 내 게재 이외의 다른 목적으로 사용할 경우에는 저작권법에 따라 저작물의 이용허락을 받아야 하며, 게시물에 대한 게시자를 반드시 명시해야 됩니다.
④ 이용자는 “치킨의 민족”을 이용함으로써 얻은 정보 중 “치킨의 민족”에게 지적재산권이 귀속된 정보를 “치킨의 민족”의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게 이용하게 하여서는 안됩니다.
⑤ “치킨의 민족”는 약정에 따라 이용자에게 귀속된 저작권을 사용하는 경우 당해 이용자에게 통보하여야 합니다.
⑥ “치킨의 민족”는 이용자의 귀책사유로 인한 서비스 이용의 장애에 대하여 책임을 지지 않습니다. 단, 회사의 귀책사유로 인한 것일 때에는 회사가 정한 바에 따라 이용자가 입은 손해에 대해 조치를 합니다.
⑦ “치킨의 민족”는 이용자가 주민등록법을 위반한 명의 도용 및 결제 도용, 저작권법 및 정보통신망 이용촉진 및 정보보호 등에 관한 법률을 위반한 불법통신 및 해킹, 악성프로그램의 배포 등과 같이 관련 법령을 위반한 경우에는 해당 이용자에 대해 즉시 영구이용정지를 할 수 있습니다. 본 항에 따른 영구 이용정지 시 해당 이용자가 보유 중인 이용할인쿠폰 및 기타 혜택 등도 모두 소멸되며, 회사는 이에 대해 별도로 보상하지 않습니다.
제24조 (게시물)
...
⑥ 귀하가 치킨의 민족서비스에서 탈퇴하는 경우, 회사는 귀하의 게시물을 귀하의 별도의 동의 없이 삭제할 수 있습니다. 또한 회사는 필요하다고 판단되는 경우, 해당 게시물을 삭제하지 않고 치킨의 민족서비스 내에 그대로 게시하거나 사업적 협력관계에 있는 제3자와 공유할 수 있는 권한을 가집니다.
제25조 (할인쿠폰 서비스)
...
제28조 (위치기반서비스의 내용)
“치킨의 민족”는 이용자의 위치정보 보호 및 위치기반 서비스 이용을 위하여 별도의 위치기반 서비스 이용약관을 마련하였으므로, 구체적인 내용은 해당 위치기반 서비스 이용약관을 확인하여 주시기 바랍니다.
제29조 (서비스의 해제 · 해지 · 청약철회)
① 회원이 이용 계약을 해지하고자 할 때는 언제든지 “치킨의 민족” 홈페이지 상의 회원 탈퇴 신청을 통해 이용계약 해지를 요청할 수 있습니다. 단, 신규가입 후 일정시간 이내에는 서비스 부정이용 방지 등의 사유로 즉시 탈퇴가 제한될 수 있습니다.
...
② “치킨의 민족”는 이용자와 가맹점 간의 재화 등 구매계약에 대해 중개 서비스를 제공할 뿐이므로, 이용자가 가맹점으로부터 구매하신 재화 등의 품질이나 가맹점의 신뢰도에 대해서는 보증하지 않습니다.
③ “치킨의 민족”는 이용자가 가맹점으로부터 구매한 재화 등에 대해 보증하거나 별도의 책임을 지지 않으며, 재화 등과 관련한 일체의 책임은 가맹점에게 있습니다.
...
제32조 (분쟁해결)
① “치킨의 민족”는 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그 피해를 보상처리하기 위하여 피해보상처리기구를 설치 ∙ 운영합니다.
② “치킨의 민족”는 이용자로부터 제출되는 불만사항 및 의견은 우선적으로 그 사항을 처리합니다. 다만, 신속한 처리가 곤란한 경우에는 이용자에게 그 사유와 처리일정을 즉시 통보해 줍니다.
③ “치킨의 민족”와 이용자간에 발생한 전자상거래 분쟁과 관련하여 이용자의 피해구제신청이 있는 경우에는 공정거래위원회 또는 시 ∙ 도지사가 의뢰하는 분쟁조정기관의 조정에 따를 수 있습니다.
④ “치킨의 민족”는 위치정보와 관련된 분쟁에 대해 당사자간 협의가 이루어지지 아니하거나 협의를 할 수 없는 경우에는 개인정보분쟁조정위원회에 조정을 신청하거나 방송통신위원회에 재정을 신청할 수 있습니다.
제33조 (재판권 및 준거법)
① “치킨의 민족”와 이용자간에 발생한 전자상거래 분쟁에 관한 소송은 제소 당시의 이용자의 주소에 의하고, 주소가 없는 경우에는 거소를 관할하는 지방법원의 전속관할로 합니다. 다만, 제소 당시 이용자의 주소 또는 거소가 분명하지 않거나 외국 거주자의 경우에는 민사소송법상의 관할법원에 따릅니다.
② “치킨의 민족”과 이용자간의 분쟁은 본 약관 및 한국법을 적용합니다.
제34조 (별정통신 서비스에 관한 공지 사항)
① 치킨의 민족서비스 중 전화주문 방식에 사용되는 050 개인번호 서비스는 델피콤㈜가 회사와의 제휴를 통하여 제공합니다.
② 050 개인번호 서비스 이용 시, 해당 번호는 이용자의 핸드폰에 해당 공급자의 상호명으로 자동 저장됩니다.
제35조 (배달대행 서비스에 관한 특칙)
① “배달대행 서비스”는 제16조 제1항과 달리 “치킨의 민족”가 가맹점을 대신하여 가맹점으로부터 재화 등을 수령하여 이용자에게 배달하는 서비스를 말합니다. “배달대행 서비스”가 제공되는 가맹점, 이용시간 및 배달지역 등 구체적인 서비스의 내용은 가맹점 및 위탁업체의 사정 등에 따라 별도로 정해집니다.
② “치킨의 민족”는 이용자에게 배달대행에 따른 배달요금을 부과할 수 있으며, 해당 요금은 배달거리, 배달시간 또는 이에 준하는 사정 등에 따라 결정됩니다. 다만, 가맹점 또는 교통 상황, 날씨, 배달대상 재화 등의 수량 또는 특성 등에 따라 배달요금이 변동될 수 있습니다.
...
⑤ 이용자는 다음 각 호의 귀책사유로 주문한 재화 등을 수령하지 못하더라도 “치킨의 민족”에 대해 대금지급 또는 손해배상의 의무가 면제되지 않으며, “치킨의 민족”는 전달하지 못한 재화 등을 보관하거나, 재배달 또는 환불하지 아니합니다.
1. 이용자가 배달받을 장소를 이용자의 과실로 잘못 기재한 경우
2. “치킨의 민족”가 이용자와 연락하기 위한 합리적인 노력을 다하였음에도 불구하고 이용자와 연락이 되지 않아 객관적으로 재화 등을 전달하기 어려운 경우
⑥ 이용자는 “치킨의 민족”에게 배달대행 서비스와 객관적으로 관련없는 요청(담배∙주류 기타 “치킨의 민족서비스”로 주문하지 아니한 재화 등의 배달, 또는 쓰레기 처리 등)을 하여서는 안되며, “치킨의 민족”는 그러한 이용자의 요청을 거절할 수 있습니다.
⑦ “치킨의 민족”가 이용자에게 배달대행 서비스를 제공하더라도, “치킨의 민족”의 귀책사유가 있거나 배달 과정에서 발생한 경우를 제외하고는 아래 각 호의 사항에 대하여 “치킨의 민족”가 가맹점의 책임을 대신하여 부담하지 아니합니다.
1. 배달된 재화 등의 내용, 수량 등이 이용자의 주문정보와 상이한 경우
2. 재화 등의 제조·조리상 하자
3. 재화 등의 손실·변질·훼손
⑧ “치킨의 민족”는 이용자에게 배달대행 서비스 제공 시, 가맹점으로부터 재화 등을 수령한 후 “치킨의 민족”의 귀책사유로 인해 이용자에게 배달이 되지 아니하거나(미배달), 재화 등의 훼손 기타 배달사고가 발생한 경우 그에 상응하는 책임을 부담합니다. 본 항에 따른 분쟁이 원만히 해결되지 않는 경우, 「소비자분쟁해결기준」(공정거래위원회 고시)에 따라 해결함을 원칙으로 합니다.
⑨ 본 조항은 “치킨의 민족”의 배달대행 서비스에 대한 책임범위를 규정하므로, “치킨의 민족”는 본 약관의 다른 규정 등에 따른 가맹점의 책임을 부담하지 않습니다.
부칙
[제1조] 본 약관은 2020년 5월 6일에 개정되었으며, 2020년 5월 14일부터 시행됩니다.
                    ...
                    <li style="list-style: none;">
                        ...
                        <label><a href="agreement2.do">전체보기</a></label>
                    </li>
                    <br>
                    <ul>
                        <li style="list-style: none;">
