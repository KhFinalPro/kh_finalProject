...
<title>치킨의민족</title>
	<style>
	    ...
	    footer>#footer_nav ul{margin: 0 auto; width:80%; list-style: none; height: 50px;}
	    ...
	    footer>#footer_nav ul li a:hover{color:black}
	    footer>#footer_Area{margin: 0 auto; width: 75%; height: 200px;}
	</style>
</head>
<body>
	<footer>
		...
		<div id="footer_Area">
			...
			<br><br>
			사업자번호 : 120-123-456 | 팩스 : 050-3451-4941
			<br>
			대표전화 : 02-1234-1235        
			<br>
			대표메일 : rngus3698@naver.com
		</div>
	</footer>
</body>
</html>