...
public class Menu implements Serializable{
	...
	public Menu(int menu_Num, String brand_Name, String menu_Name, String menu_Price, String menu_Exp, String menu_Yn,
			String cat_Name, String menu_Pic) {
		super();
	...
	public String toString() {
		return "Menu [menu_Num=" + menu_Num + ", brand_Name=" + brand_Name + ", menu_Name=" + menu_Name
				+ ", menu_Price=" + menu_Price + ", menu_Exp=" + menu_Exp + ", menu_Yn=" + menu_Yn + ", cat_Name="
				+ cat_Name + ", menu_Pic=" + menu_Pic + "]";
	}
